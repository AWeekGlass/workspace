...
public class MyBatisPlusGenerator {
	...
	public void generator() {
		...
		pc.setParent(null);
		pc.setEntity("com.hengyu.user.entity");
		pc.setMapper("com.hengyu.user.dao");
		pc.setXml("mappings");
		pc.setController("com.hengyu.user.web");
		pc.setService("com.hengyu.user.service");
		pc.setServiceImpl("com.hengyu.user.service.impl");
